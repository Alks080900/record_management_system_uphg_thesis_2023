...
<head>
	<meta charset="UTF-8">
	<title>Student Management SHS</title>
...
<div class="container">
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="form-group col-lg-3">
            ...
            <input oninput="this.value = this.value.toUpperCase()" type="text" class="form-control" id="LName" placeholder="Last Name" name="Lastname" value="" required>
          </div>
        <div class="form-group col-lg-3">
          <label class="required" for="firstname">First Name</label>
          <input oninput="this.value = this.value.toUpperCase()" type="text" class="form-control" id="FName" placeholder="First Name" name="Firstname" value="" required>
        </div>
        <div class="form-group col-lg-3">
            <label >Middle Name</label>
            <input oninput="this.value = this.value.toUpperCase()" type="text" class="form-control" id="MName" placeholder="Middle Name" name="Middlename" value="">
          </div>
          <div class="form-group col-lg-3">
          ...
          <div class="form-group col-lg-3">
            ...
            <select class="form-control form-select" class="course1" name="Strand" style="margin-top:15px;"required>
            <option value="">Choose</option>
...
if (isset($_POST['submit'])) {
    ...
    $Year = mysqli_real_escape_string($conn, $_POST['Year']);
        ...
        $target_dir_PSA = "C:/xampp/htdocs/Capstone/uploads/SHS/PSA/";
        $target_dir_Form138 = "C:/xampp/htdocs/Capstone/uploads/SHS/Form138/";
        $target_dir_Form137 = "C:/xampp/htdocs/Capstone/uploads/SHS/Form137/";
        $target_dir_Picture = "C:/xampp/htdocs/Capstone/uploads/SHS/Picture/";
        $target_dir_MOA = "C:/xampp/htdocs/Capstone/uploads/SHS/MOA/";
        ...
        if (!empty($MOA)) {
          ...
          $query = "INSERT INTO shsstud (Stud_ID, Lastname, Firstname, Middlename, Extensionname, Gender, Nationality, DoB, PoB, ContactNumber, Strand, Email, Perm_Address, PSA, Form138, Form137, Picture, MOA, Status, Year, user_date, am_pm) VALUES ('$Stud_ID', '$Lastname', '$Firstname', '$Middlename', '$Extensionname', '$Gender', '$Nationality', '$DoB', '$PoB', '$ContactNumber', '$Strand', '$Email', '$Perm_Address', '$PSA', '$Form138', '$Form137', '$Picture', '$MOA', '1', '$Year', DATE_FORMAT(NOW(), '%Y-%m-%d %h:%i:%s'), DATE_FORMAT(NOW(), '%p'))";
      ...
      if(isset($_SESSION['login'])) {
        ...
        $action = "ADDED $Firstname $Lastname IN SHS";
