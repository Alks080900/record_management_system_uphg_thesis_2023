...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $mail->setFrom('uphsgregistrar@gmail.com', 'UPHS-GMA || REGISTRAR');
...
<div class="container">
  <div class="form-container">
    ...
    <form action="" method="POST">
      ...
      <br>
      <div class="g-recaptcha" data-sitekey="6Lc4nbgkAAAAAOz6DtmicAbaJ2r57-yAaViCe1Aq" data-callback="callback"></div>
      <br>
      <button type="submit" id="submit-button" class="btn btn-primary" disabled>Send Email</button>
    </form>
  </div>
</div>
